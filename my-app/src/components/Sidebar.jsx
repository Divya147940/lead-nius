...
const Sidebar = ({ activeCategory, onCategoryChange }) => {
  ...
  const [selectedShopByCategory, setSelectedShopByCategory] = useState([]);
                    ...
                    {item.subCategories.map((sub) => (
                      <div 
                        ...
                        style={{ 
                          ...
                          color: selected.includes(sub.name) ? '#2563eb' : '#64748b', cursor: 'pointer', animation: 'fadeInSub 0.2s ease-out'
                        }}
                      >
                         <div style={{ 
